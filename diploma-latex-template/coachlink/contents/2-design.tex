...
Такое разделение упрощает маршрутизацию на уровне API Gateway, делает API понятным для внешних клиентов и позволяет документировать каждую группу endpoint-ов независимо. Полная спецификация API оформлена в формате OpenAPI и доступна в репозитории проекта.
